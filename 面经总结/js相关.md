...
详见[/js原理/typeof_instanceof_isprototypeof.js](/js原理/typeof_instanceof_isprototypeof.js){:target="_blank"}  
...
3. 查询自有属性的方法  
详见[/js/原型链的属性遍历.js](/js/原型链的属性遍历.js){:target="_blank"}  
...
详见[/js原理/this理解.js](/js原理/this理解.js){:target="_blank"}  
...
10. 深浅拷贝  
详见[/js原理/js对象的深浅拷贝(克隆).js](/js原理/js对象的深浅拷贝(克隆).js){:target="_blank"}  
...
（3）更广的适用性  
（4）返回值是 Promise  
详见[async 函数](https://es6.ruanyifeng.com/#docs/async){:target="_blank"}
...
23. 观察者模式实现  
详见[/js原理/观察者模式.js](/js原理/观察者模式.js){:target="_blank"}  
...
30. 排序方法  
冒泡、选择、插入、快排、归并、哈希  
详见[/数据结构与算法/算法/排序](/数据结构与算法/算法/排序){:target="_blank"}  
  
31. 对象属性不可修改  
Object.freeze->Object.seal->preventExtensions->writable\configurable  
  
32. Event Loop 事件循环  
[参考这篇博文，讲的非常清楚](https://juejin.im/post/5c947bca5188257de704121d){:target="_blank"}
